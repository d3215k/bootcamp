...
<head>
    ...
    <meta name="description"
        content="Together let's walk through building and deploying a modern Laravel application from scratch.">
...
<body x-data="{ navIsOpen: false }" class="font-sans antialiased text-gray-900">
    @yield('content')
</body>
